...
public class Constants {
  ...
  public static final String[] TOUCHSCREEN_MUSIC_GESTURES_ARRAY = {
    TOUCHSCREEN_DOUBLE_SWIPE_NODE, TOUCHSCREEN_LEFT_ARROW, TOUCHSCREEN_RIGHT_ARROW
  };
  ...
  public static final String[] sButtonPrefKeys = {
    NOTIF_SLIDER_TOP_KEY, NOTIF_SLIDER_MIDDLE_KEY, NOTIF_SLIDER_BOTTOM_KEY
  };
  ...
  static {
    ...
    sBooleanNodePreferenceMap.put(TOUCHSCREEN_FLASHLIGHT_GESTURE_KEY, TOUCHSCREEN_FLASHLIGHT_NODE);
